...
See in 'ordered-set' project:
https://github.com/rspeer/ordered-set/blob/34f2cba9f9509909506adeff51ddebac6060bf1b/test/test_ordered_set.py
"""
...
def test_type_subscription():
    set1 = OrderedSet[str]("abc")
    assert repr(set1) == "OrderedSet(['a', 'b', 'c'])"
