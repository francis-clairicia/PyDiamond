...
if any(name.startswith("pygame") for name in list(sys.modules)):
    import warnings

    warn_msg = "'pygame' module already imported, this can cause unwanted behaviour. Consider import py_diamond first."
